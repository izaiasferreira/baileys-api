...
export default function MessageComponent({ message, onChange }) {
    const { client, chatDataBase } = useContext(AppContext)
    ...
    } else if (msg?.type.typeMessage === 'image' || msg?.type.typeMessage === 'video' || msg?.type.typeMessage === 'audio') {
        return (
            <div>
                <ToastContainer />
                <div className=
            ...
            <div>
                ...
                >
                    ...
                    <div className={msg.type.typeMessage === 'text' ? "message-middle-text" : "message-middle"}>
                        <div className="message-middle-content">
                            <div className='content'>
                                <MessageComponentToResponseMessage typeMessage={msg?.response?.type?.typeMessage} text={msg?.response?.text} url={msg?.response?.file} />
                                <FilesForMessages m={msg} />
                                {msg?.text ? <div className="text-and-hour">
                                    <span className='text-message'>{msg?.text}</span>
                                    <span className={msg.type.toShow === true ? 'footer-hour' : 'footer-hour-attendance'} >
    ...
    else if (msg?.type.typeMessage.substring(0, msg?.type.typeMessage.indexOf('/')) === 'document') {
        return (
            <div>
                <ToastContainer />
                <div className=
                ...
                >
                    ...
                    <div className="message-middle">
                        <div className="message-middle-content">
                            <div className='content'>
                                <FilesForMessages m={msg} />
                                {msg?.text ? <div className="text-and-hour"><div className='text-message'> {msg?.text}</div>
                                    <span className={msg?.type.toShow === true ? 'footer-hour' : 'footer-hour-attendance'} >
                                        {msg?.hour}
                                        {
                                            statusSend ?
